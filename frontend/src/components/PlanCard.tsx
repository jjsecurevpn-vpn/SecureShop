...
const PlanCard: React.FC<PlanCardProps> = ({ plan, onSelect, loading }) => {
  ...
  return (
    <div className="bg-gradient-to-br from-gray-900 to-gray-950 rounded-xl shadow-lg hover:shadow-2xl hover:shadow-violet-500/20 transition-all duration-300 border border-gray-800/60 hover:border-violet-500/50 p-6 flex flex-col">
      {/* Header */}
      ...
      <div className="text-center mb-6">
        <div className="flex items-baseline justify-center">
          <span className="text-4xl font-bold text-violet-400">${precioMensual}</span>
      ...
      <div className="flex-grow mb-6">
        <ul className="space-y-3">
          <li className="flex items-center text-gray-300">
            <svg className="w-5 h-5 text-violet-400 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
      ...
      <button
        ...
        className={`w-full py-3 px-6 rounded-xl font-semibold text-white transition-all duration-200 ${
          loading
            ...
            : 'bg-violet-600 hover:bg-violet-700 hover:shadow-lg hover:shadow-violet-500/30 transform hover:-translate-y-0.5'
        }`}
      >
