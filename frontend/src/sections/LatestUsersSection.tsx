    ...
    <section className="py-20">
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 bg-purple-500/5 border border-purple-500/15 rounded-full mb-6">
            <div className="w-1 h-1 rounded-full bg-purple-400"></div>
            <span className="text-xs font-light text-purple-300/90 tracking-wide">
              USUARIOS RECIENTES
            </span>
          </div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-2 gap-4">
            {usuarios.map((usuario) => (
              <div
                key={usuario.id}
                className="group bg-neutral-900/40 border border-neutral-800/60 rounded-xl p-6 hover:border-purple-500/25 hover:bg-neutral-900/60 transition-all duration-300"
              >
                {/* Header */}
                <div className="flex items-center gap-4 mb-5">
                  <div className="w-11 h-11 bg-gradient-to-br from-purple-500/10 to-purple-700/10 border border-purple-500/20 rounded-full flex items-center justify-center flex-shrink-0">
                    <User className="w-5 h-5 text-purple-300/90" strokeWidth={1.5} />
                  </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-2xl font-light text-purple-300/90 tabular-nums tracking-tight">
        ...
        {usuarios.length === 0 && (
          <div className="text-center py-20">
            <div className="w-14 h-14 bg-neutral-900/40 border border-neutral-800/60 rounded-full flex items-center justify-center mx-auto mb-4">
              <User className="w-6 h-6 text-purple-300/70" strokeWidth={1.5} />
            </div>
